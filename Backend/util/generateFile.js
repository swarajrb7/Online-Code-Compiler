...
const { v4: getID } = require("uuid"); //renamed the version v4 function to getid

const codeDirPath = path.join(__dirname, "..", "codes");
const inputDirPath = path.join(__dirname, "..", "inputs");

if (!fs.existsSync(codeDirPath)) { 
    fs.mkdirSync(codeDirPath, { recursive: true }); // this fucntion makes sure that the folder exists
}
